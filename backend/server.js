...
app.post("/insert", async (req, res) => {
  ...
  try {
    const formattedDate = formatDate(new Date(date)); // Format the date before storing

    const salesRecord = new SalesData({
      date: formattedDate,  // Store formatted date as a string
      name,
      quantity,
      price,
      total
